...
document.getElementById("submit-button").addEventListener("click", function renderResult() {
    let queryString = CampusExplorer.buildQuery();
    CampusExplorer.sendQuery(queryString)
        .then((result) => {
